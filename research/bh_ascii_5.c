// bh_ascii.c — Simplified Schwarzschild ASCII rings (3 rotating hotspots)
...
static char RAMP[] = " `.,-:'_;~*/\\^\"<>!=()+?{}|[]#%$&@";
static double gamma_c = 0.25; // display gamma
...
int main(int argc, char** argv){
  ...
  for(;;){
    ...
    // accumulate intensity per frame
    double Imax=1e-12;
